...
export type BreedsFragmentFragment = { __typename?: 'Breed', id: string, name: string, origin: string };
...
export const BreedsFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"BreedsFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Breed"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"origin"}}]}}]} as unknown as DocumentNode<BreedsFragmentFragment, unknown>;
