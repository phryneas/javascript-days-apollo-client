...
export type UpdateDogMutationVariables = Exact<{ [key: string]: never; }>;


export type UpdateDogMutation = { __typename: 'Mutation' };
...
export const UpdateDogDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateDog"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"__typename"}}]}}]} as unknown as DocumentNode<UpdateDogMutation, UpdateDogMutationVariables>;